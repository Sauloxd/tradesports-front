	...
	$(window).load(function(){
		...
		(function(){
			if($('.products_container').length){
				...
				var iso1 = new Isotope( '.products_container', {
			...
			if($('.portfolio_isotope_container').length){
				...
				var iso2 = new Isotope( '.portfolio_isotope_container', {
			...
			if($('.portfolio_masonry_container').length){
				...
				var iso3 = new Isotope( '.portfolio_masonry_container', {
					itemSelector : '.portfolio_item',
					layoutMode : 'masonry',
					masonry: {
					  columnWidth: 10,
